...
linkedin: 'https://linkedin.com/in/contributor-linkedin',
},
];
      ...
      <footer className="lp-footer">
        <div className="lp-footer-inner">
          ...
          <div className="lp-footer-links">
            <a href="https://github.com/your-github-username" title="GitHub"   target="_blank" rel="noreferrer"><Github   size={18} /></a>
            <a href="https://linkedin.com/in/your-linkedin-username" title="LinkedIn" target="_blank" rel="noreferrer"><Linkedin size={18} /></a>
          </div>
        </div>
      </footer>
